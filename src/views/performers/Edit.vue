<template>
  <b-col>
    ...
    <div class="form-group">
      <label for="contact_phone" class="col-md-3 control-label"
        >Contact Phone</label
      >
      <div class="col-md-6">
        <input
...
export default {
  ...
  methods: {
    getData() {
      ...
      api
        ...
        .then(response => {
          ...
          this.form.title = this.performer.title;
          this.form.description = this.performer.description;
          this.form.contact_email = this.performer.contact_email;
          this.form.contact_phone = this.performer.contact_phone;
        })
    ...
    submitForm() {
      ...
      api
        .put(`/performers/${this.$route.params.id}`, formData, {
          headers: {
